              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 flex items-center gap-2">
                  <Image
                    ...
                    height={30}
                  />
                  <span className="text-white text-2xl font-bold">Kait</span>
                </Link>
                <p className="text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                ...
                <div className="flex items-center">
                  <Link
                    ...
                    className="text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary"
                  >
                    <svg
                      width="9"
                      height="18"
                  ...
                  <Link
                    href="/"
                    aria-label="social-link"
                    className="text-body-color-dark text-body-color duration-300 hover:text-primary"
                  >
                    <svg
                      width="17"
                      height="16"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <Link
                      href="/blogs"
                      className="text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-primary"
                    >
                      Blog
                    </Link>
                  </li>
          ...
          <div className="h-px w-full bg-gradient-to-r from-transparent via-[#D2D8E183] to-transparent">
            <div className="py-8">
              <p className="text-center text-base text-white">
                Copyright @ 2025 Khoa Huynh KAIT DEVELOPER. All rights reserved.{" "}
              </p>
            </div>
          </div>
