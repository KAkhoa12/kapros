...
const NewsLatterBox = () => {
  return (
    <div
      className="wow fadeInUp shadow-three relative z-10 rounded-sm bg-gray-dark p-8 sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      ...
      <p
        className="mb-11 border-b border-white border-opacity-25 pb-11 text-base leading-relaxed text-body-color-dark
"
      >
        {" "}
